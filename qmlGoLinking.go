...
type QmlBridge struct {
	...
	_ func(amountWEAK string) string `slot:"getTransferAmountUSD"`
...
func connectQMLToGOFunctions() {
	...
	qmlBridge.ConnectGetTransferAmountUSD(func(amountWEAK string) string {
		return amountStringUSDToWEAK(amountWEAK)
	})
