...
const urlWeaknessCoinRemoteNodes = "https://raw.githubusercontent.com/weaknesscoin/weaknesscoin-nodes-json/master/weaknesscoin-nodes.json"
...
func requestListRemoteNodes() (remoteNodes []node) {
	...
	theNodes := new(nodes)
	err := getJSONFromHTTPRequest(urlWeaknessCoinRemoteNodes, theNodes)
