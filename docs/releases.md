...
- Updated to patch for CLI argument discrepancies in weakness-service
- Includes WeaknessCoin core 0.12.0 (weakness-service and WeaknessCoind) and checkpoints.csv as of 12th of January 2019.
...
- Includes WeaknessCoin core 0.8.4 (weakness-service and WeaknessCoind) and checkpoints.csv as of 29th of October 2018.

### Sha256

WeaknessCoin-Nest-0.36-Windows.zip:
`a54285fef3863a3bdc03f3e3af2e3abcc88305767239d1f4cb0615c6c0b75613`

WeaknessCoin-Nest-0.36-Mac.zip:
`b370c8fa0b7c98d38ec97ab558794e2c2bee0a759d19c219390422ef8393001a`

WeaknessCoin-Nest-0.36-Linux.tar.gz:
...
- Dropdown list for choosing a remote node (list is requested from https://github.com/weaknesscoin/weaknesscoin-nodes-json).
- Can use checkpoints for syncing local chain (includes checkpoints.csv as of 3rd of October 2018).
- Various small improvements.
- Includes WeaknessCoin core 0.8.3 (weakness-service and WeaknessCoind).

### Sha256

WeaknessCoin-Nest-0.35-Windows.zip:
`7c41be52bf33af36172f12f9aac9ce5d04cb4b6942dbcf24b2f6092f8964ea19`

WeaknessCoin-Nest-0.35-Mac.zip:
`8ce0a26cde80fd4f12e02382257195dd43865e94adf1acd20752be0033db2623`

WeaknessCoin-Nest-0.35-Linux.tar.gz:
...
- Uses weakness-service and WeaknessCoind 0.8.0.

### Sha256

WeaknessCoin-Nest-0.32-Windows.zip:
`0957dfcd42aa4fa3332d4419c888144cbf0fc0cd8f3ce4b3b2954e2d57dc9858`

WeaknessCoin-Nest-0.32-Mac.zip:
`a84eb3d5e56e3bcae27c6688ba070a6a7393a4141b1aa7eb1217cc4082e7957e`

WeaknessCoin-Nest-0.32-Linux.tar.gz:
...
- Uses weakness-service and WeaknessCoind 0.7.0.

Regarding the local blockchain option: WeaknessCoind will be launched in the background if you did not launch it manually. Some difficulties can arise, please check the different log files to understand the problem (especially WeaknessCoind-session.log) or ask some help in the discord. You will also avoid issues if you launch WeaknessCoind manually before launching Nest (and potentially wait for sync). Please tell us if you have issues so we can improve for the next release. 

### Sha256

WeaknessCoin-Nest-0.31-Windows.zip:
`e3f6ad0f377528fd3e28d30a9ae9a8db69229f5ffd00a272993808db25ee49d6`

WeaknessCoin-Nest-0.31-Mac.zip:
`f2325823c268be8b8bc3feeaece0f4d141a13e80a2cbbfe49b55420afa0baa98`

WeaknessCoin-Nest-0.31-Linux.tar.gz:
